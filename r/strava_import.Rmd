...
strava <- rbind_pages(df_list)
```

## Basic cleaning of the data

```{r clean imported data}
strava_clean <- strava %>% clean_names() %>% 
...
strava_clean %>% select(.,-start_latlng, -end_latlng, -start_latitude,-start_longitude) %>% 
    save(., file = "D:/Users/Danny/Documents/GitHub/strava/data/strava.RData")
